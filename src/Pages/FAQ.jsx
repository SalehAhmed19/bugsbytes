      ...
      <div className="lg:w-4/5 lg:mx-auto mx-4">
        <Fade up>
          ...
          >
            ...
            <AccordionDetails>
              <Typography sx={{ color: "#fff" }}>
                Web design focuses on the visual aspects of a website, such as
                the layout and user interface. Web development focuses on the
                coding and back-end functionality of a website, such as
