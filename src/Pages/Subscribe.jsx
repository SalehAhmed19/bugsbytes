...
const Subscribe = () => {
  return (
    <Fade up>
      <div className="lg:w-4/5 bg-[#023A20] bg-subs lg:py-14 py-5 lg:px-10 px-3 mx-4 lg:mx-auto mb-56 mt-10 flex flex-col lg:flex-row justify-between items-center rounded-lg">
        <div>
          ...
          <p className="text-[#6BF176] my-3">
            By clicking the button, you are agreeing with our Term and
            Conditions
          </p>
          <div className="flex justify-between bg-[#00983f] rounded-full">
            <input
              ...
              className="py-4 px-5 w-full bg-transparent rounded-full text-[#6BF176] placeholder-[#1c6524] focus:outline-none text-xl"
            />{" "}
            <button className="mx-2">
              <ArrowCircleRightIcon
                className="text-[#6BF176]"
                fontSize="large"
              />
            </button>
          </div>
